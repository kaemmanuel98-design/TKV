-- Community comments migration (safe/idempotent)
-- Execute in Supabase SQL editor.
-- Goal: add wall comments with RLS policies.

DO $$
BEGIN
  IF to_regclass('public.community_posts') IS NULL THEN
    RAISE EXCEPTION 'community_posts table is required before running this migration';
  END IF;
END
$$;
