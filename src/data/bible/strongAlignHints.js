...
export const LANG_ANCHORS = {
  ...
  en: [
    { en: ['god'], fr: ['god'] },
    { en: ['beginning'], fr: ['beginning', 'start'] },
    { en: ['created', 'create'], fr: ['made', 'create', 'created'] },
    { en: ['heavens', 'heaven'], fr: ['heaven', 'heavens'] },
    { en: ['earth'], fr: ['earth'] },
    { en: ['light'], fr: ['light'] },
    { en: ['darkness'], fr: ['dark', 'darkness'] },
    { en: ['waters', 'water'], fr: ['waters', 'water'] },
    { en: ['spirit'], fr: ['spirit', 'breath'] },
    { en: ['day'], fr: ['day'] },
    { en: ['night'], fr: ['night'] },
    { en: ['lord'], fr: ['lord'] },
    { en: ['jesus'], fr: ['jesus'] },
